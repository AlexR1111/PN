...
const UeberMich = () => (
  ...
  <div className='aboutmetext'>
    ...
    In den folgenden Jahren habe ich vor allem meine Familie für unser gemeinsames Hobby ausgestattet, Zelte genäht und auch für Freunde individuelle Kleidungsstücke angefertigt Seit nunmehr 16 Jahren bin ich mit dem historisch angelegten Verein die <strong>Freyen Rittersleut zu Randingen</strong> im Mittelalter unterwegs. Meine aktuellen Nähprojekte sind fest in dieser Epoche verwurzelt - mit viel Liebe zum Detail und historischer Genauigkeit.<br/><br/> 
