...
const UeberMich = () => (
  ...
  <div className='aboutmetext'>
    ...
    Die ersten historischen Schnittmuster - sogenannte "Past Patterns" aus Amerika - musste ich noch mühsam von Hand übersetzen. Doch genau diese Herausforderung entfachte meine Leidenschaft für historische Gewandungen.<br/><br/> 
    In den folgenden Jahren habe ich vor allem meine Familie für unser gemeinsames Hobby ausgestattet, Zelte genäht und auch für Freunde individuelle Kleidungsstücke angefertigt Seit nunmehr 16 Jahren bin ich mit dem historisch angelegten Verein die <strong>Freye Rittersleut zu Randingen e.V</strong> im Mittelalter unterwegs. Meine aktuellen Nähprojekte sind fest in dieser Epoche verwurzelt - mit viel Liebe zum Detail und historischer Genauigkeit.<br/><br/> 
    Seit meinem Eintritt in den Ruhestand habe ich beschlossen, mein Hobby in einen kleinen Beruf zu verwandeln - und so entstand <strong>Pia's Nähstube</strong>. Hier nähe ich nicht nur historische Gewandungen, sondern widme mich auch dem Upcycling moderner Materialien.<br/><br/>
    ...
    Nähen ist für mich nicht nur Handwerk - es ist Ausdruck von Geschichte, Persönlichkeit und Nachhaltigkeit. Ich freue mich, wenn ich mit meiner Arbeit ein Stück dieser Leidenschaft weitergeben kann.</p>
